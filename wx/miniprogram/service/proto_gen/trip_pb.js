...
export const coolcar = $root.coolcar = (() => {
    ...
    coolcar.Trip = (function() {
         ...
         * @property {Array.<coolcar.ILocation>|null} [pathLocationns] Trip pathLocationns
        ...
        /**
         * Trip pathLocationns.
         * @member {Array.<coolcar.ILocation>} pathLocationns
         * @memberof coolcar.Trip
         * @instance
         */
        Trip.prototype.pathLocationns = $util.emptyArray;
        ...
        Trip.fromObject = function fromObject(object) {
            ...
            if (object.pathLocationns) {
                if (!Array.isArray(object.pathLocationns))
                    throw TypeError(".coolcar.Trip.pathLocationns: array expected");
                message.pathLocationns = [];
                for (let i = 0; i < object.pathLocationns.length; ++i) {
                    if (typeof object.pathLocationns[i] !== "object")
                        throw TypeError(".coolcar.Trip.pathLocationns: object expected");
                    message.pathLocationns[i] = $root.coolcar.Location.fromObject(object.pathLocationns[i]);
                }
            }
        ...
        Trip.toObject = function toObject(message, options) {
            ...
            if (message.pathLocationns && message.pathLocationns.length) {
                object.pathLocationns = [];
                for (let j = 0; j < message.pathLocationns.length; ++j)
                    object.pathLocationns[j] = $root.coolcar.Location.toObject(message.pathLocationns[j], options);
            }
